      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            {/* ✅ Map container with LocateFixed button */}
            <div className="relative mt-6 h-[330px] rounded-xl overflow-hidden border border-gray-200 shadow-inner">
              {position && (
               <CheckOutMap position={position} setPosition={setPosition} setAddress={setAddress} />
              )}

              {/* ✅ Outside MapContainer but inside the relative wrapper so it floats over the map */}
              <motion.button
                whileTap={{ scale: 0.93 }}
