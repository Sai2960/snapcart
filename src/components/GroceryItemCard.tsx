      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <span className="text-green-700 font-bold text-lg">
            ₹{isNaN(Number(item.price)) ? "N/A" : Number(item.price)}
          </span>
        </div>
        {!cartItem ? (
          <motion.button
          ...
          <motion.div
            ...
            className="mt-4 flex items-center justify-center bg-green-50 border border-green-200 rounded-full py-px-4 gap-4"
          >
            <button
